                    ...
                    <div data-spy="scroll" class="tabbable-panel">
                        <div class="tabbable-line">
                            <ul class="nav nav-tabs ">
                                ...
                                <li>
                                    <a href="#tab_default_5" data-toggle="tab">Listas de reproducción</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab_default_5">
                                    <a href="listas-reproduccion.html"><p class="text-center">Ir a sus listas</p></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-block">Follow</button>
                                </div>
                            </div>
                        </div>
                    </div>
