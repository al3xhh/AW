...
<html lang="es">
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
	  ...
	  //se encuentra en correo
      if(strpos($correo, '@' ) !== false) {
         //si se encuentra la @
		 if(!existeCorreo($correo))//pero el correo no esta en la bbdd
            $errorUsuario = true;
      } 
	  else{
		  //si no esta el @ (puede ser el usuario entonces)
         if(!existeUsuario($correo))//si no existe el usuario en la bbdd
            $errorUsuario = true;
      }
